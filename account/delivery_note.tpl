				...
				<table class="table">
					<tr>
						<td style="text-align:left;background:none;">
							<h1><?php echo img( 'images/zimall3-220x74.png' );?></h1>
						</td>
						<td style="text-align:left;background:none;">
							<small><?php echo $this->config->item('address');?></small><br>
							<small><?php echo lang('site-phone').', '.lang('sales-email')?></small><br>
							<small>www.zimall.co.zw</small>
						</td>
						<td style="text-align:left;background:none;">
							<h2>DELIVERY NOTE</h2>
						</td>
			...
			<table class="table table-striped table-invoice table-responsive">
				...
				<tbody>
					...
					<tr>
						...
						<td class="no-back" style="text-align:left;padding-left:0!important;"><?php echo $item['name'];?></td>
					</tr>
					<tr>
