		...
		<div class="modal-content">
			...
			<?php echo form_open(current_url(), 'class="form-horizontal"'); ?>
				...
				<div class="modal-header">
					...
					<h4 class="modal-title">Guest Checkout - Add Delivery Address</h4>
				</div>
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label class="control-label col-sm-4" for="company">Recipient Name:<small> ( optional )</small></label>
						<div class="col-sm-6">
							<input type="text" id="recipient" name="recipient" value="<?php echo $this->input->post('recipient');?>" 
							class="form-control input-sm">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							...
							<input type="text" name="city" list="city_list" class="form-control input-sm" 
								value="<?php echo $this->input->post('city')?>" required>
				...
				<div class="modal-footer">
					...
					<input type="hidden" name="used_add" value="different">
				</div>
