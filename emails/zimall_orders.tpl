		...
		<td style="width:100%;display: block!important;max-width: 600px!important;margin: 0 auto!important;clear: both!important;" >
				...
				<table bgcolor="#e7e7e7" style="width:100%">
					<tr>
						...
						<td align="right"><h6 <?php echo $h6collapse;?>>New Order</h6></td>
					</tr>
				</table>
				</div>
	...
	<tr>
		...
		<td <?php echo $container;?> bgcolor="#FFFFFF">
			...
			<table>
				<tr>
					<td>
						<h3 <?php echo $h3;?>><?php echo $invoice['fname'].' '.$invoice['surname'];?> has placed an order</h3>
...
<tfoot>
	...
	<tr>
		...
		<td colspan="2"><em><?php echo $invoice['coupon_name'].' ['.$invoice['coupon_id'].']';?></em> </td>
