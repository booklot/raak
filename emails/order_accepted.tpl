		...
		<td style="width:100%;display: block!important;max-width: 600px!important;margin: 0 auto!important;clear: both!important;" >
				...
				<table bgcolor="#e7e7e7" style="width:100%">
					<tr>
						...
						<td align="right"><h6 <?php echo $h6collapse;?>>Order Accepted</h6></td>
					</tr>
				</table>
				</div>
	...
	<tr>
		...
		<td <?php echo $container;?> bgcolor="#FFFFFF">
			...
			<table>
				<tr>
					<td>
						<h3 <?php echo $h3;?>>Hi, <?php echo $invoice['fname'].' '.$invoice['surname'];?></h3>
						<p class="lead">Your order on <?php echo lang('site-name');?> has been accepted. If you had not already made a payment, please proceed and do so.</p>
