				...
				<div class="row-fluid">
					...
					<div class="span3">
						...
						<div class="newslatter">
							<?php echo form_open( 'account/subscribe' );?>
								<div class="input-prepend">
									<span class="add-on"><i class="icon-user"></i></span>
									<input class="input-block-level span10" type="text" name="name" value="" placeholder="Your Name..." Name="">
								</div>
								<div class="input-prepend">
									<span class="add-on">@</span>
									<input class="input-block-level span10"type="text"name="email" value="" placeholder="Your E-Mail..." Name="">
								</div>
								<input type="hidden" name="subscribe_to_newsletter" value="1">
								<input type="hidden" name="nl_id" value="1">
								<input type="hidden" name="return_url" value="<?php echo current_url();?>">
								<button class="btn btn-block" type="submit" name="subscribe"><?php echo lang('join-us-now'); ?></button>
							</form>
						</div>
...
<?php //$this->load->view("$theme/common/switcher.tpl")?>
